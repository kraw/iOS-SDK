...
@interface DebugView : UITabBarController <UITextFieldDelegate>{
}
...
@property (weak, nonatomic) IBOutlet UISwitch *regularScan;
- (IBAction)swRegularScan:(id)sender;

@property (weak, nonatomic) IBOutlet UISwitch *fastScan;
